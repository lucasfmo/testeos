...
# <a name="connect-to-an-ibm-mq-server-from-logic-apps-using-the-mq-connector"></a>Connect to an IBM MQ server from logic apps using the MQ connector 
...
## <a name="add-a-trigger"></a>Add a trigger
...
## <a name="browse-a-single-message"></a>Browse a single message
...
## <a name="browse-multiple-messages"></a>Browse multiple messages
...
## <a name="receive-a-single-message"></a>Receive a single message
...
## <a name="receive-multiple-messages"></a>Receive multiple messages
